...
import { Calendar, Award, GraduationCap, Phone, Mail, MapPin, FileText, ExternalLink, ChevronRight } from "lucide-react"
  ...
  return (
    <div className="flex min-h-screen flex-col">
      ...
      <main className="flex-1">
        {/* Hero Section */}
        <section className="relative w-full py-12 md:py-24 lg:py-32 overflow-hidden bg-gradient-to-b from-blue-50 to-white dark:from-blue-950 dark:to-background">
          <HeroParticles />
          <div className="container px-4 md:px-6 relative z-10">
            <div className="grid gap-6 lg:grid-cols-2 lg:gap-12 items-center">
              <div className="space-y-4">
                <div className="inline-block animate-bounce-slow">
                  <Badge className="bg-blue-100 text-blue-700 hover:bg-blue-100 dark:bg-blue-900 dark:text-blue-300 dark:hover:bg-blue-900 text-sm px-3 py-1">
                    ¡Admisiones Abiertas 2025!
                  </Badge>
                </div>
                <h1 className="text-4xl font-bold tracking-tighter sm:text-5xl md:text-6xl bg-clip-text text-transparent bg-gradient-to-r from-blue-600 to-blue-400 dark:from-blue-400 dark:to-blue-200">
                  Ingeniería en TIC
                </h1>
                <p className="max-w-[600px] text-muted-foreground md:text-xl">
                  Forma parte de los profesionales que transforman el mundo a través de la tecnología.
                  <span className="font-semibold text-blue-600 dark:text-blue-400"> ¡El futuro te espera!</span>
                </p>
                <div className="flex flex-col sm:flex-row gap-3 pt-2">
                  <Button
                    size="lg"
                    className="bg-blue-600 hover:bg-blue-700 rounded-full group transition-all duration-300 transform hover:scale-105"
                  >
                  ...
                  <Button
                    size="lg"
                    variant="outline"
                    className="rounded-full group transition-all duration-300 transform hover:scale-105 hover:bg-blue-50 dark:hover:bg-blue-900/30"
                  >
              ...
              <div className="mx-auto lg:mx-0 relative aspect-video overflow-hidden rounded-2xl shadow-xl transform transition-all duration-500 hover:scale-[1.02] hover:shadow-2xl">
                <div className="absolute inset-0 bg-gradient-to-tr from-blue-600/20 to-transparent z-10 rounded-2xl"></div>
                <Image
                  src="/placeholder.svg?height=720&width=1280"
                  alt="Estudiantes de Ingeniería en TIC"
                  width={1280}
                  height={720}
            ...
            <div className="grid grid-cols-2 md:grid-cols-4 gap-4 md:gap-8 mt-16 relative">
              <AnimatedCounter
